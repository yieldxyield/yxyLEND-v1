...
class Account extends Component {
  ...
  renderConnected = () => {
    ...
    if (account && account.address) {
      address = account.address.substring(0,6)+'...'+account.address(account.address.length-4,account.address.length)
    }
  ...
  renderNotConnected = () => {
    ...
    return (
      <div className={ classes.notConnectedRoot }>
        <Typography variant={'h5'} className={ classes.disclaimer }>Yield by Yield</Typography>
